...
namespace Microsoft.CodeAnalysis.Razor.ProjectSystem
{
    internal class MvcExtensibilityConfiguration : ProjectExtensibilityConfiguration
    {
        ...
        public override string DisplayName => $"MVC: {MvcAssembly.Identity.Version.ToString(3)}" + (Kind == ProjectExtensibilityConfigurationKind.Fallback? " (fallback)" : string.Empty) + " | " + RazorLanguageVersion;
        ...
        public override RazorLanguageVersion RazorLanguageVersion { get; }
        ...
        public override bool Equals(ProjectExtensibilityConfiguration other)
        {
            ...
            return 
                ...
                RazorLanguageVersion == other.RazorLanguageVersion;
        }
