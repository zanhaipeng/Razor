...
namespace Microsoft.VisualStudio.ProjectSystem.Razor
{
    ...
    /// </summary>
    internal partial class CompileItemHandler : AbstractEvaluationCommandLineHandler, IEvaluationHandler, ICommandLineHandler
    {
        private readonly UnconfiguredProject _project;
        private readonly IWorkspaceProjectContext _context;

        public CompileItemHandler(UnconfiguredProject project, IWorkspaceProjectContext context)
            : base(project)
        {
        ...
        public void Handle(IComparable version, IProjectChangeDescription projectChange, bool isActiveContext, IProjectLogger logger)
        {
            ...
            // Just do nothing, we don't want the .cs files.
        }
